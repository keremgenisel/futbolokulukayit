...
export interface Player {
  ...
  kan_grubu: string;
  foto_yolu: string;
  yas_grubu_id: number | null;
  yas_grubu_ad?: string | null;
  durum: Durum;
...
export interface Attendance {
  ...
  training_id: number;
  player_id: number;
  durum: "geldi" | "gelmedi" | "izinli";
  ad_soyad?: string;
}

export interface LisansDurum {
  mod: "lisansli" | "deneme" | "saltOkunur";
  neden?: string;
  firma?: string;
  bitis: string | null;
  maksKullanici: number | null;
  kalanGun: number | null;
  makineId?: string;
  saatGeriAlindi?: boolean;
}
  ...
  interface Window {
    okul: {
      ...
      files: {
        ...
        ): Promise<{ ok?: boolean; iptal?: boolean; id?: number; dosya_yolu?: string }>;
      ...
      cikti: {
        ...
        excelKaydet(
          veri: { sayfa: string; sutunlar: { baslik: string; anahtar: string; genislik?: number }[]; satirlar: Record<string, unknown>[] },
          oneriAd?: string,
        ): Promise<{ ok?: boolean; iptal?: boolean; yol?: string }>;
      };
      yedek: {
        ...
        durum(): Promise<{
          ...
          istemci?: boolean;
          siklik?: string;
          sikliklar?: { kod: string; ad: string }[];
        }>;
        siklik(siklik: string): Promise<{ ok?: boolean; error?: string; siklik?: string }>;
        geriYukleSec(): Promise<{
          ok?: boolean;
          iptal?: boolean;
          error?: string;
          klasor?: string;
          oyuncu?: number;
          makbuz?: number;
          sonMakbuz?: string | null;
        }>;
        geriYukle(klasor: string): Promise<{ ok?: boolean; error?: string }>;
      };
      aktar: {
        sablon(): Promise<{ ok?: boolean; iptal?: boolean; error?: string; yol?: string }>;
        onizle(): Promise<{
          ok?: boolean;
          iptal?: boolean;
          error?: string;
        ...
        uygula(kayitlar: any[]): Promise<{ ok?: boolean; error?: string; eklenen?: number; yeniGrup?: number }>;
      };
      optimize: {
        analiz(): Promise<{
          ok?: boolean;
          error?: string;
          resim?: { adet: number; bayt: number; gruplar: Record<string, { adet: number; bayt: number }> };
          diger?: { adet: number; bayt: number };
        }>;
        uygula(): Promise<{
          ok?: boolean;
          error?: string;
      ...
      app: {
        ...
        logo(): Promise<string>;
        whatsappAc(numara: string, metin: string): Promise<{ ok?: boolean; error?: string }>;
      };
