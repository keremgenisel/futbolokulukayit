...
/**
 * @param {{ baslik: string, altBaslik?: string, sutunlar: {baslik: string, anahtar: string, sag?: boolean}[], satirlar: Record<string, unknown>[], logo?: string, yatay?: boolean, kulup?: string, tema?: {ana?: string, vurgu?: string} }} p
 */
export function raporHtml({
  baslik,
  altBaslik = "",
  sutunlar,
  satirlar,
...
<style>
  ...
  .ust { display: flex; align-items: center; gap: 4mm; border-bottom: 1mm solid ${t.mor}; padding-bottom: 3mm; margin-bottom: 4mm; }
  .ust img { width: 14mm; height: 14mm; object-fit: contain; }
  h1 { font-size: 16pt; margin: 0; color: ${t.morKoyu}; }
  .alt { color: #6B6480; font-size: 9.5pt; margin-top: 1mm; }
  table { width: 100%; border-collapse: collapse; }
  th { text-align: left; font-size: 8.5pt; text-transform: uppercase; letter-spacing: .05em; color: ${t.morKoyu}; background: ${t.morAcik}; padding: 2mm; border-bottom: 1px solid #CFC7DC; }
