...
export class ErrorBoundary extends React.Component {
  ...
  componentDidCatch(hata, bilgi) { console.error("Arayüz hatası:", hata, bilgi); }
  render() {
    ...
    return (
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: "100%", gap: 12, padding: 32 }}>
        ...
        <button onClick={() => window.location.reload()} style={{ background: "var(--mor)", color: "#fff", border: 0, borderRadius: 8, padding: "10px 18px", fontWeight: 700 }}>Yeniden Başlat</button>
      </div>
    );
  }
}
