...
describe("saha yoklama formu HTML'i", () => {
  ...
  it("işaretli oyuncu dolu kutuyla, işaretsiz üç boş kutuyla gelir; sonda ek boş satır yok (plan §17.3)", () => {
    ...
    expect(ada.indexOf("kutu dolu")).toBeLessThan(ada.indexOf("Gelmedi") === -1 ? Infinity : 0); // ilk kutu
    expect(ada).toMatch(/Ada Kaya.*<div class="kutu dolu">.*<div class="kutu">.*<div class="kutu">/s);
    expect(baris.match(/class="kutu"/g)).toHaveLength(3);
